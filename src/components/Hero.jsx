...
// Separate Counter Component for the Stats Counter Animation
...
export default function Hero() {
    // Parent container stagger configuration
    ...
    // Standard fade-in up movement for sections
    ...
    // Statistics cards animation grid
    const cardVariants = {
    ...
    // Words for Heading Animation
    const headingText = "Find Your Dream Job Today";
    ...
    return (
        <motion.div 
            ...
            className="relative min-h-screen bg-[#030712] text-white overflow-hidden flex flex-col items-center justify-between px-4 pt-28 pb-12 md:pt-36 md:pb-20"
        >
            ...
            <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
                ...
                <motion.div 
                    ...
                    className="absolute w-full h-full bottom-0 left-1/2 -translate-x-1/2 flex items-end justify-center"
                >
            ...
            {/* Top Badge */}
            <motion.div variants={fadeInUpVariants} className="z-10">
            ...
            <div className="z-10 text-center max-w-3xl mt-6 md:mt-8 space-y-4">
                <h1 className="text-3xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-b from-white to-neutral-400 bg-clip-text text-transparent px-2 flex flex-wrap justify-center gap-x-3 md:gap-x-4">
                    {words.map((word, idx) => (
                        <motion.span
                            key={idx}
                ...
                <motion.p variants={fadeInUpVariants} className="text-xs md:text-base text-neutral-400 max-w-xl mx-auto leading-relaxed px-4">
            ...
            {/* Search Bar Section */}
            <motion.div variants={fadeInUpVariants} className="z-10 w-full max-w-4xl mt-8 md:mt-10 px-2 md:px-4 mx-auto flex flex-col items-center justify-center">
            ...
            <motion.div variants={fadeInUpVariants} className="z-10 text-center px-4 mt-10 mb-4 md:mb-12">
            ...
            <div className="z-10 w-full max-w-6xl grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mt-4 md:mt-6">
                {[
                    { icon: FiBriefcase, value: "50", suffix: "K", label: "Active Jobs" },
                    { icon: FiLayers, value: "12", suffix: "K", label: "Companies" },
                    { icon: FiUsers, value: "2", suffix: "M", label: "Job Seekers" },
                    { icon: FiAward, value: "97", suffix: "%", label: "Satisfaction Rate" }
                ].map((stat, idx) => (
                    <motion.div
                        ...
                        key={idx}
                        className="bg-gradient-to-b from-neutral-900/90 to-neutral-950/90 border border-neutral-800/60 p-4 md:p-6 rounded-2xl flex flex-col justify-between h-28 md:h-36 backdrop-blur-md transition-all shadow-xl"
                    >
