...
export default function Hero() {
    return (
        <div className="relative min-h-screen bg-[#030712] text-white overflow-hidden flex flex-col items-center justify-between px-4 py-12 md:py-20">
            ...
            {/* Top Badge */}
            <div className="z-10">
                <span className="inline-flex items-center gap-2 bg-neutral-900/80 border border-neutral-800 backdrop-blur-md px-4 py-1.5 rounded-full text-neutral-300 text-xs font-medium tracking-wider uppercase z-10">
            ...
            <div className="z-10 text-center max-w-3xl mt-8 space-y-4">
            ...
            {/* Search Bar Section - 100% Error Free & Exact Match with image_032ca0.png */}
            <div className="z-10 w-full max-w-4xl mt-10 px-4 mx-auto flex flex-col items-center justify-center">
                <div className="w-full bg-[#0d0d0d]/40 border border-neutral-800/80 p-2 pl-5 rounded-xl backdrop-blur-xl shadow-2xl flex flex-col md:flex-row items-center gap-4">

                    {/* Job Title Input */}
                    <div className="w-full md:flex-1 flex items-center gap-3 py-1">
                    ...
                    {/* Search Button Styled Exactly Like the Image */}
                    <Button
                        isIconOnly
                        radius="none"
            ...
            <div className="z-10 text-center px-4 mt-12 mb-6 md:mb-12">
                <h2 className="text-xl md:text-3xl font-medium tracking-tight text-neutral-200">
                    Assisting over <span className="font-bold text-white">15,000 job seekers</span>
                </h2>
                <p className="text-sm md:text-lg text-neutral-400 mt-1">
                    find their dream positions.
                </p>
            </div>

            {/* Statistics Cards Grid */}
            <div className="z-10 w-full max-w-6xl grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                {[
                    ...
                    <div
                        key={idx}
                        className="bg-gradient-to-b from-neutral-900/90 to-neutral-950/90 border border-neutral-800/60 p-6 rounded-2xl flex flex-col justify-between h-36 backdrop-blur-md hover:border-neutral-700/80 transition-all shadow-xl"
                    >
                        <stat.icon className="text-neutral-400 text-xl" />
                        <div>
